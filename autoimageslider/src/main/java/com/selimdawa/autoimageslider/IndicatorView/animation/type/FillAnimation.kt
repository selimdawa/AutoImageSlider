...
class FillAnimation(listener: ValueController.UpdateListener) : ColorAnimation(listener) {
    ...
    private val value: FillAnimationValue = FillAnimationValue()
    ...
    fun with(colorStart: Int, colorEnd: Int, radius: Int, stroke: Int): FillAnimation {
        if (animator != null && hasChanges(colorStart, colorEnd, radius, stroke)) {
            ...
            animator!!.setValues(
                colorHolder, reverseColorHolder,

                radiusHolder, radiusReverseHolder,

                strokeHolder, strokeReverseHolder
            )
        }
    ...
    private fun hasChanges(
        colorStart: Int, colorEnd: Int, radiusValue: Int, strokeValue: Int
    ): Boolean {
    ...
    companion object {
        ...
        const val DEFAULT_STROKE_DP: Int = 1
    }
}
